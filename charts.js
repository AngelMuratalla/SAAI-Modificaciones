...
- Hacer que la funcion generate solo genere los graficos que necesitamos (agrgar el parametro)
- Añador los atributos correspondientes a cada grafico para seguir la generalización indicada 
- Cambiar atributo columns de la lista de graficos por data 
- Total de docentes adscritos al Sistema Nacional de Investigación (SNI) ARREGLAR
- Agregar tablita 
*/
...
columns: 'Los datos que vamos a mostrar en el gráfico (2D array)'
title: 'Titulo del grafico'
xTitle: 'Titulo del eje horizontal'
yTitle: 'Título del eje vertical'
type: 'tipo de grafico a construir'

Esto puede variar un poco dependiendo de tipo de grafico que se desea construir.
*/
let chartNumber = 1;
...
function createMultipleLineChart(chartObject){
    c3.generate({
        bindto: chartObject.bindto,
        data: {
            xs: chartObject.xs,
            columns: chartObject.columns,
        },
...
function createBarChart(chartObject){
    c3.generate({
        bindto: chartObject.bindto,
...
function createDonutChart(chartObject){
    c3.generate({
        bindto: chartObject.bindto,
...
function createPieChart(chartObject){
    c3.generate({
        bindto: chartObject.bindto,
        data: chartObject.data,
        pie: {
